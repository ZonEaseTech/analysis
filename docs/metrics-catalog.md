...
| 业务域 | 指标 |
|---|---|
| 销售域 | [GMV / 总营业额](#gmv) · [Net Sales / 净销售额](#net-sales) · [Gross Profit / 销售毛利](#gross-profit) · [dine_gmv / 堂食营业额](#dine-gmv) · [takeout_gmv / 外卖营业额](#takeout-gmv) · [COGS / 物料成本](#cogs) · [refund_amount / 退款金额](#refund-amount) · [free_amount / 赠品金额](#free-amount) · [give_amount / 赠送金额](#give-amount) · [discount_amount / 调价折扣](#discount-amount) · [cancelled_amount / 外卖取消](#cancelled-amount) |
...
**注意 / 排障**：当前是管理会计 Net Sales，不等同法定财报口径（VAT 含税/不含税未确认）。详见 pnl-accounting-standards-gap.md Gap 3。
